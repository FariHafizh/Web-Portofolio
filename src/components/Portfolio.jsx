...
const TABS = [
  ...
  { id: 'tech-stack', label: content.portfolio.tabs.techStack },
...
export default function Portfolio() {
  ...
  const { panels, project: projectLabels } = content.portfolio;
  ...
  return (
    <Section id="portfolio" title={title} intro={intro}>
      ...
      <div className="panel-wrapper">
        ...
        <TabPanel id="tech-stack" activeTab={activeTab}>
          <h3 className="panel-title">{panels.techStackTitle}</h3>
          <p className="panel-intro">{panels.techStackIntro}</p>
